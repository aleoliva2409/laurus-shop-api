...
export class InitialMigration1721743200808 implements MigrationInterface {
    name = 'InitialMigration1721743200808'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "variants" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "stock" integer NOT NULL, "sku" character varying(50), "price" numeric(10,2), "sizeId" integer NOT NULL, "colorId" integer NOT NULL, "productId" uuid NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_672d13d1a6de0197f20c6babb5e" PRIMARY KEY ("id"))`);

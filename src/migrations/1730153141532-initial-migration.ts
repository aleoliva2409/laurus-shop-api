...
export class InitialMigration1730153141532 implements MigrationInterface {
    name = 'InitialMigration1730153141532'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "variants_in_orders" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "quantity" integer NOT NULL, "variantId" uuid NOT NULL, "orderId" uuid NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_79f774723d003824bf47a6fe327" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."orders_payment_type_enum" AS ENUM('cash', 'bankTransfer', 'mercadopago')`);
        await queryRunner.query(`CREATE TYPE "public"."orders_delivery_type_enum" AS ENUM('pickUpInStore', 'shipping')`);
        ...
        await queryRunner.query(`CREATE TABLE "orders" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "is_paid" boolean NOT NULL DEFAULT false, "paid_at" date, "is_delivered" boolean NOT NULL DEFAULT false, "delivered_at" date, "payment_type" "public"."orders_payment_type_enum" NOT NULL, "delivery_type" "public"."orders_delivery_type_enum" NOT NULL, "payment_status" "public"."orders_payment_status_enum" NOT NULL DEFAULT 'noPay', "shipping_status" "public"."orders_shipping_status_enum", "delivery_status" "public"."orders_delivery_status_enum", "transaction_id" character varying(70), "total" numeric(10,2) NOT NULL, "total_items" integer NOT NULL, "userId" uuid NOT NULL, "addressId" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_710e2d4957aa5878dfe94e4ac2f" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."orders_delivery_type_enum"`);

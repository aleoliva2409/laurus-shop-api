...
export class InitialMigration1721784021917 implements MigrationInterface {
    name = 'InitialMigration1721784021917'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "images" ("id" SERIAL NOT NULL, "url" character varying(255) NOT NULL, "variantId" uuid NOT NULL, CONSTRAINT "PK_1fe148074c6a1a91b63cb9ee3c9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "variants" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "stock" integer NOT NULL, "sku" character varying(50), "price" numeric(10,2) NOT NULL DEFAULT '0', "mainVariant" boolean NOT NULL DEFAULT false, "sizeId" integer NOT NULL, "colorId" integer NOT NULL, "productId" uuid NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_672d13d1a6de0197f20c6babb5e" PRIMARY KEY ("id"))`);
